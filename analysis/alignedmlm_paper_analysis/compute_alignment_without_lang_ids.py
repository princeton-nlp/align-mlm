"""
This is used for computing alignment for words trained using MLM or DICT-MLM.

Example command: python compute_alignment_without_lang_ids.py --model1 ~/bucket/model_outputs/en/one_to_one_mapping_100_500K/mlm/ --model2 ~/bucket/model_outputs/en/one_to_one_mapping_100_500K/mlm/ --train_fraction 0.05 --valid_fraction 0.9
"""
