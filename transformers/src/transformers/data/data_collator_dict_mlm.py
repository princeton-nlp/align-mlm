...
@dataclass
class DataCollatorForLanguageModelingDictMLM:
    """
    ...
    def __call__(
        ...
        #         examples['input_ids'][j] = [examples['input_ids'][j][i] if (examples['input_ids'][j][i] in special_tokens \
        #           or examples['input_ids'][j][i] in dont_modify) else (examples['input_ids'][j][i] + vocab_size) \
        #           for i in range(len(examples['input_ids'][j]))]
        #     return examples

        # def map_function(examples):
        #     for j in range(len(examples['input_ids'])):
        #         examples['input_ids'][j] = [examples['input_ids'][j][i] if (examples['input_ids'][j][i] in special_tokens) \
        #         else (examples['input_ids'][j][i] + vocab_size)  for i in range(len(examples['input_ids'][j]))]
        #     return examples
...
@dataclass
class DataCollatorForWholeWordMask(DataCollatorForLanguageModelingDictMLM):
    """
...
@dataclass
class DataCollatorForSOP(DataCollatorForLanguageModelingDictMLM):
    """
    ...
    def __init__(self, *args, **kwargs):
        warnings.warn(
            ...
            "DataCollatorForLanguageModelingDictMLM instead.",
            FutureWarning,
        )
